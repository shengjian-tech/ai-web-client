...
const shouldUseSourceMap =false; //禁止build项目生成map文件
  ...
  return {
    ...
    entry: {
      ...
      function:"./src/content/function.mjs",
       coze:"./src/content/coze.js",
       background: './src/background/background.js',

    },
    devServer: {
      // contentBase: '../build',  // 编译输出目录
      open: true,             // 自动打开浏览器
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            //       //     plugins: [
            //       //       postcssPresetEnv({
            //       //         // 自动添加浏览器前缀，兼容 flexbox 等特性
            //       //         autoprefixer: {
            //       //           flexbox: 'no-2009',
            //       //         },
            //       //         stage: 3, // CSS 特性阶段
            //       //       }),
            //       //       // 其他 postcss 插件，例如：postcss-nested, postcss-import 等
            //       //     ],
            //       //   },
            //       // },
            //     },
